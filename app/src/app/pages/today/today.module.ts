...
import { SkeletonComponent } from './components/top/components/skeleton/skeleton.component';
...
@NgModule({
  ...
  declarations: [TodayPage, TopComponent, BottomComponent, HoursAnimDirective, SkeletonComponent]
})
